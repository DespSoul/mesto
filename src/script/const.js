...
export const profileAvatarImage = document.querySelector('.profile__avatar-container');
export const popupFormSaveAvatar = document.querySelector(".popup__form-save-avatar")